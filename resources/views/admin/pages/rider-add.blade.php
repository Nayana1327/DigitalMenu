                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Delivery Person - <small></small>Add</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <!-- form start -->
                        <form id="rider_add" action="{{route('rider-insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rider_name" id="rider_name" class="form-control" placeholder="Enter Name" autocomplete="off" maxlength="50">
                                            @if ($errors->has('rider_name'))
                                            <span class="help-block">
                                                <strong class="error-text">{{ $errors->first('rider_name') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary" id="rider_add_form_submit">Submit</button>
                            <button type="button" class="btn btn-secondary" id="rider_add_form_cancel">Cancel</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
<script>
    ...
    $('#rider_add_form_cancel').click(function(){
        window.location.href="{{ route('rider-list') }}";
    })
